			...
			<div className="w-full row p-4">
                <p className="text-4xl p-2 border-l-8 border-emerald-600">Photos</p>
					<div className="w-full grid grid-cols-1 p-4 gap-y-4 md:grid-cols-2 md:gap-2 lg:grid-cols-4 lg:gap-4">
                        ...
                        <div className="w-full h-auto flex flex-cols flex-wrap items-start justify-center rounded">
							<Image src="/../public/src/gallery/Team.JPG" width={300} height={300} className="object-cover rounded "></Image>
							<p className="text-md p-4 text-center font-semibold">MedTech IIT Kanpur</p>
						</div>
					</div>
