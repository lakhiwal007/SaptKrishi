    ...
    <div className="w-full min-h-[50vh] grid grid-cols-1 rounded bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-60 border border-gray-200 mt-8  relative">
			...
			<div className="w-full h-full flex items-center justify-center p-4 lg:p-16 relative" 
				...
				<div className="w-full flex flex-col items-center justify-center text-white">
                    ...
                    <p className="text-justify text-md font-semibold">It is a self-sustainable solution that only require 20 watt of electricity either on-grid or off-grid, and a litre of water per day.</p>
				</div>
			</div>
		</div>
  )
