			...
			<div className="w-full flex items-center justify-center flex-wrap p-8 md:p-16">
                <Splide className="w-full flex items-center justify-center" aria-label="My Favorite Images"
                    ...
                    <SplideSlide className="flex items-center justify-center">
                        <div data-aos="fade-up" className="w-[350px] h-[350px] flex items-center justify-center relative rounded m-auto mt-4 group">
                        <Image
                    ...
                    <SplideSlide className="flex items-center justify-center">
                        <div data-aos="zoom-in-down" className="w-[350px] h-[350px] flex items-center justify-center relative rounded m-auto mt-4 group">
                            <Image
