			...
			<div className="row justify-content-center">
				<div className="col-12 col-sm-8 col-lg-6">
					...
					<div className="section_heading text-center wow fadeInUp mt-4" data-wow-delay="0.2s" style={{ visibility: 'visible', animationDelay: '0.2s', animationName: 'fadeInUp' }}>
						...
						<p className="text-md pb-4">A diverse team from different background collborated to build an innovative product to respond Sustainable Development Goals.</p>
