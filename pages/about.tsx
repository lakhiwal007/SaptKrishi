					...
					<div className="w-full flex items-center justify-center mt-16 m-auto">
						<div className="w-full grid grid-cols-1 gap-y-4  md:grid-cols-2 lg:grid-cols-3 lg:gap-4 lg:ml-12">
							<div className=" w-40 h-40 md:w-60 md:h-60   flex items-center justify-center shadow-lg rounded-full transition ease-in-out duration-500 hover:scale-110 ">
								<Image src="/../public/src/awards/award1.PNG" width={200} height={200} className="border rounded-full" alt="..."></Image>
							</div >
							<div className=" w-40 h-40 md:w-60 md:h-60  flex items-center justify-center shadow-lg rounded-full transition ease-in-out duration-500 hover:scale-110">
								<Image src="/../public/src/awards/award2.png" width={200} height={200} className="border rounded-full" alt="..."></Image>
							</div>
							<div className=" w-40 h-40 md:w-60 md:h-60  flex items-center justify-center shadow-lg rounded-full transition ease-in-out duration-500 hover:scale-110">
								<Image src="/../public/src/awards/award3.png" width={200} height={200} className="border rounded-full" alt="..."></Image>
							</div>
							<div className=" w-40 h-40 md:w-60 md:h-60  flex items-center justify-center shadow-lg rounded-full transition ease-in-out duration-500 hover:scale-110">
								<Image src="/../public/src/awards/award4.png" width={200} height={200} className="border rounded-full" alt="..."></Image>
							</div>
							<div className=" w-40 h-40 md:w-60 md:h-60  flex items-center justify-center shadow-lg rounded-full transition ease-in-out duration-500 hover:scale-110">
								<Image src="/../public/src/awards/award5.png" width={200} height={200} className="border rounded-full" alt="..."></Image>
							</div>
							<div className=" w-40 h-40 md:w-60 md:h-60  flex items-center justify-center shadow-lg rounded-full transition ease-in-out duration-500 hover:scale-110">
								<Image src="/../public/src/awards/award6.png" width={200} height={200} className="border rounded-full" alt="..."></Image>
							</div>
						</div>
					</div>
				</div>
