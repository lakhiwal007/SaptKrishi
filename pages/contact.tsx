				...
				<div className="w-3/4  mih-h-screen border shadow p-3 mb-5 bg-body rounded md:w-1/2">
					<div className="mb-3">
						...
						<input
							type="text"
                            name="Name"
							className={errors.Name ? "form-control border-red-600" : "form-control"}
						...
						/>
                        {errors.Name && <p className="text-sm text-red-600">Enter your name *</p>}
					</div>
					<div className="mb-3">
						...
						<input
							type="email"
                            name="Email"
							className={errors.Email ? "form-control border-red-600" : "form-control"}
							id="formGroupExampleInput2"
							placeholder="example@email.com"
                            {...register("Email", { required: true })}
                            onChange={(event) => handleInput(event)}
						/>
                        {errors.Email && <p className="text-sm text-red-600">Enter your email address *</p>}
					</div>
					...
					<div className="mb-3">
						...
						<input
							type="text"
                            name="Subject"
							className={errors.Subject ? "form-control border-red-600" : "form-control"}
							id="formGroupExampleInput4"
							placeholder="subject"
                            {...register("Subject", { required: true })}
                            onChange={(event) => handleInput(event)}
						/>
                        {errors.Subject && <p className="text-sm text-red-600">Enter subject *</p>}
					</div>
					<div className="mb-3">
