   	...
   	<div>
		...
		<h1 className="text-4xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-yellow-400 md:text-6xl">News</h1>
            ...
            <Splide aria-label="My Favorite Images"
                    ...
                    <Image src="/../public/src/news/img47.jpg" width={500} height={450} className="object-fit rounded"  alt="Image 1"></Image>
                    </SplideSlide>
                    <SplideSlide className="flex items-center justify-center">
                    <Image src="/../public/src/news/img7.jpg" width={500} height={450} className="object-fit rounded" alt="Image 2"></Image>
                    </SplideSlide>
                    <SplideSlide className="flex items-center justify-center">
                    <Image src="/../public/src/news/img27.jpg" width={500} height={450} className="object-fit rounded"  alt="Image 1"></Image>
                    </SplideSlide>
                    <SplideSlide className="flex items-center justify-center">
                    <Image src="/../public/src/news/img72.jpg" width={500} height={450} className="object-fit rounded" alt="Image 2"></Image>
                    </SplideSlide>
                    <SplideSlide className="flex items-center justify-center">
                    <Image src="/../public/src/news/img32.jpg" width={500} height={450} className="object-fit rounded"  alt="Image 1"></Image>
                    </SplideSlide>
                    <SplideSlide className="flex items-center justify-center">
                    <Image src="/../public/src/news/img37.jpg" width={500} height={450} className="object-fit rounded" alt="Image 2"></Image>
                    </SplideSlide>
                    <SplideSlide className="flex items-center justify-center">
                    <Image src="/../public/src/news/img62.jpg" width={500} height={450} className="object-fit rounded" alt="Image 2"></Image>
                    </SplideSlide>
                    <SplideSlide className="flex items-center justify-center">
                    <Image src="/../public/src/news/img57.jpg" width={500} height={450} className="object-fit rounded" alt="Image 2"></Image>
                    </SplideSlide>
                    <SplideSlide className="flex items-center justify-center">
                    <Image src="/../public/src/news/img22.jpg" width={500} height={450} className="object-fit rounded" alt="Image 2"></Image>
                    </SplideSlide>
                    </Splide>
        </div>
        <div className="w-full flex items-center justify-center flex-wrap p-4 mt-16">
